...
@implementation QLMineChildInfoItem
- (id)init{
    if (self = [super init]) {
        self.cellHeight = 184;
...
@implementation QLMineChildInfoCell

- (void)cellDidLoad
{
    [super cellDidLoad];
    
    UIView *bgView = [[UIView alloc] initWithFrame:CGRectMake(24, 0, WTScreenWidth-24-23, 184)];
