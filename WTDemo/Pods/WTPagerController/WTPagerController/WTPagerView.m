...
@interface WTPagerView ()<WTPagerViewLayoutDataSource, WTPagerViewLayoutDelegate> {
    // private
    struct {
...
// Data
@property (nonatomic, strong) WTPagerViewLayout<UIView *> *layout;

@end

@implementation WTPagerView
...
- (void)addLayoutScrollView {
    ...
    WTPagerViewLayout<UIView *> *layout = [[WTPagerViewLayout alloc]initWithScrollView:contentView];
...
- (void)setDelegate:(id<WTPagerViewDelegate>)delegate {
    _delegate = delegate;
