...
@interface WTTabPagerController ()<WTTabPagerBarDataSource,WTTabPagerBarDelegate,WTPagerControllerDataSource,WTPagerControllerDelegate>

// UI
@property (nonatomic, strong) WTTabPagerBar *tabBar;
@property (nonatomic, strong) WTPagerController *pagerController;
...
@implementation WTTabPagerController
...
- (WTTabPagerBar *)tabBar {
    if (!_tabBar) {
        _tabBar = [[WTTabPagerBar alloc]init];
    }
    return _tabBar;
}
...
- (WTPagerController *)pagerController {
    if (!_pagerController) {
        _pagerController = [[WTPagerController alloc]init];
    }
    return _pagerController;
}

- (WTPagerViewLayout<UIViewController *> *)layout {
...
#pragma mark - WTPagerControllerDataSource
...
#pragma mark - WTPagerControllerDelegate
