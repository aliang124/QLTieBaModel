...
@interface WTPagerController ()<WTPagerViewLayoutDataSource, WTPagerViewLayoutDelegate> {
    // private
    struct {
...
// Data
@property (nonatomic, strong) WTPagerViewLayout<UIViewController *> *layout;

@end


@implementation WTPagerController

- (WTPagerViewLayout<UIViewController *> *)layout {
    if (!_layout) {
        UIScrollView *scrollView = [[UIScrollView alloc]init];
        WTPagerViewLayout<UIViewController *> *layout = [[WTPagerViewLayout alloc]initWithScrollView:scrollView];
...
- (void)setDelegate:(id<WTPagerControllerDelegate>)delegate
{
    _delegate = delegate;
...
#pragma mark - WTPagerViewLayoutDataSource
...
#pragma mark - WTPagerViewLayoutDelegate
