...
@class WTPagerView;
@protocol WTPagerViewDataSource <NSObject>
...
@protocol WTPagerViewDelegate <NSObject>
@optional
...
- (void)pagerView:(WTPagerView *)pagerView didAppearView:(UIView *)view forIndex:(NSInteger)index;

// Disappear customization

- (void)pagerView:(WTPagerView *)pagerView willDisappearView:(UIView *)view forIndex:(NSInteger)index;
...
- (void)pagerViewDidScroll:(WTPagerView *)pageView;
...
@interface WTPagerView : UIView

@property (nonatomic, weak, nullable) id<WTPagerViewDataSource> dataSource;
@property (nonatomic, weak, nullable) id<WTPagerViewDelegate> delegate;
